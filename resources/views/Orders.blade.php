...
<html lang="en">
  <head>
    ...
    <title>Orders Managemnt</title>         <link rel="icon" href="pic/pic2.png" type="image/icon type">
...
<!------------------>
                        ...
                        <tr class="cartpage">
                            ...
                            <td> <h6>{{$order2->address}}</h6><input type='hidden' id='iprice' ></td></td>
                            
                                <td>{{$order2->order_id}}</td>
                               <td><button type="button" class="btn btn-danger" onclick="cnt()"><a href="{{route('cancel', [$order2->order_id])}}">Cancel</a></button></td>
