...
<html>
    ...
    <title>Login </title>         <link rel="icon" href="pic/pic2.png" type="image/icon type">
    ...
    <div class="container-fluid" style="width: 80%;">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                ...
                <form class="form-container" method="post" name="myform" method="post" action="login"  onsubmit="return validation()" >
                    @csrf
                    <h1 style="text-align: center"> Login Form </h1>
                    <div id="error_message"></div>
                    <div class="form-group">
                      <label for="inputEmail4" class="form-label" >Username</label> 
                      <input type="text2" class="form-control" id="user" name="username" placeholder="Username" > 
                      <span id="name"></span>
                    </div>
        ...
        ?>
                      ...
                      <button  type="submit" class="btn btn-success btn-block"  style="width: 100%; left: 20px;" >Login</button>
                      <div class="form-check">
                    ...
                    <br>
                    <p>Dont have an account ?<a href="/SignUP">Register now</a> </p> 
                  </form>
